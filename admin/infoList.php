...
$info = $db->in_array("SELECT * FROM info ORDER BY id ASC LIMIT $page_start, $page_count");
    
include "head.php";

$breadcump_title_1 = "Qo'shimcha ma'lumotlar";
$breadcump_title_2 = "Ma'lumotlar ro'yxati";
?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <tbody id="customers">
                                    <? foreach ($info as $info){ ?>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            <td class="py-2"><?=$info["id"]?></td>
                                            <td id="info_image" class="py-2"><img src="<?=$image["file_folder"]?>" width="125px"></td>
                                            <td class="py-2"><?=admin_lng($info["name"])?></td>
                                            <td class="py-2"><?=admin_lng($info["description"])?></td>
                                            <td class="py-2"><?=$info["created_date"]?></td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/admin/editInfo/?id=<?=$info["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="admin/editInfo/?id=<?=$info["id"]?>&type=deleteinfo">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        // count
                            $count = (int)$db->assoc("SELECT COUNT(*) FROM info")["COUNT(*)"];
