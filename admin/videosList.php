...
$videos = $db->in_array("SELECT * FROM youtube_videos  ORDER BY id ASC LIMIT $page_start, $page_count");
    
include "head.php";

$breadcump_title_1 = "Video - hisobot";
$breadcump_title_2 = "Videolar ro'yxati";
?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <tbody id="customers">
                                    <? foreach ($videos as $video){ ?>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            <td class="py-2"><?=$video["id"]?></td>
                                            <td id="video_image" class="py-2"><img src="<?=$image["file_folder"]?>" width="125px"></td>
                                            <td class="py-2"><?=$video["video"]?></td>
                                            <td class="py-2"><?=$video["created_date"]?></td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/admin/editVideo/?id=<?=$video["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="admin/editVideo/?id=<?=$video["id"]?>&type=deletevideo">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        // count
                            $count = (int)$db->assoc("SELECT COUNT(*) FROM youtube_videos")["COUNT(*)"];
