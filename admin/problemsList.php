...
$problems = $db->in_array("SELECT * FROM problems ORDER BY id ASC LIMIT $page_start, $page_count");

include "head.php";

$breadcump_title_1 = "Muammolar";
$breadcump_title_2 = "Muammolar ro'yxati";
?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table table-responsive-md mb-0 table-bordered" id="table">
                                ...
                                <tbody id="customers">
                                    <? foreach ($problems as $problem){ 
                                        $science = $db->assoc("SELECT * FROM sciences WHERE problem_id = ?", [ $problem["id"] ]);    
                                    ?>

                                        <tr class="btn-reveal-trigger">
                                            <td class="py-2"><?=$problem["id"]?></td>
                                            <td class="py-2"><?=$problem["name"]?></td>
                                            <td class="py-2"><?=$science["name"]?></td>
                                            <td class="py-2"><?=$problem["created_date"]?></td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown">  
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/admin/editProblem/?id=<?=$problem["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="/admin/editProblem/?id=<?=$problem["id"]?>&type=deleteproblem">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        // count
                            $count = (int)$db->assoc("SELECT COUNT(*) FROM problems")["COUNT(*)"];
