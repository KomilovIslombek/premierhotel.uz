                                ...
                                <tbody id="customers">
                                    <? foreach ($employees as $employee){ ?>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2">
                                                <a href="/admin/editEmployee/?id=<?=$employee["id"]?>" ><?=($employee["last_name"] . " " . $employee["first_name"])?></a>
                                            </td>
                                            ...
                                            <td class="py-2 text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/admin/editEmployee/?id=<?=$employee["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="/admin/editEmployee/?id=<?=$employee["id"]?>&type=deleteemployee">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
