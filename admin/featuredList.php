...
$featured = $db->in_array("SELECT * FROM featured  ORDER BY id ASC LIMIT $page_start, $page_count");
    
include "head.php";

$breadcump_title_1 = "Mehmonxona xususiyatlari";
$breadcump_title_2 = "Xususiyatlar ro'yxati";
?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                                            ...
                                            <td class="py-2 text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/admin/editFeatured/?id=<?=$advantage["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="admin/editFeatured/?id=<?=$advantage["id"]?>&type=deletefeatured">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        // count
                            $count = (int)$db->assoc("SELECT COUNT(*) FROM featured")["COUNT(*)"];
