...
$gallery = $db->in_array("SELECT * FROM gallery ORDER BY id ASC LIMIT $page_start, $page_count");

include "head.php";

$breadcump_title_1 = "Galeriya";
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table table-responsive-md mb-0 table-bordered" id="table">
                                ...
                                <tbody id="customers">
                                    <? foreach ($gallery as $galleryImage){ ?>
                                        <?
                                            $image = image($galleryImage["image_id"]);
                                        ?>
                                        
                                        <tr class="btn-reveal-trigger">
                                            <td class="py-2"><?=$galleryImage["id"]?></td>
                                            <td class="py-2"><img src="<?=$image["file_folder"]?>" width="125px"></td>
                                            <td class="py-2"><?=$galleryImage["created_date"]?></td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/admin/editGallery/?id=<?=$galleryImage["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="admin/editGallery/?id=<?=$galleryImage["id"]?>&type=deletegallery">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        // count
                            $count = (int)$db->assoc("SELECT COUNT(*) FROM gallery")["COUNT(*)"];
