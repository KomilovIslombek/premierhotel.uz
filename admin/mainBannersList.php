...
$mainBanners = $db->in_array("SELECT * FROM main_banners  ORDER BY id ASC LIMIT $page_start, $page_count");
    
include "head.php";

$breadcump_title_1 = "Bannerlar";
$breadcump_title_2 = "Bannerlar ro'yxati";
?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div style="min-height: 250px;" class="table-responsive">
                            <table class="table table-responsive-md mb-0 table-bordered" id="table">
                                <thead>
                                    <tr>
                                        <th>#id</th>
                                        <th id="table_image">Rasmi</th>
                                        <th>Sarlavha</th>
                                        <th>Sarlavha izohi</th>
                                        <th>Video linki</th>
                                ...
                                <tbody id="customers">
                                    <? foreach ($mainBanners as $mainBanner){ ?>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            <td class="py-2"><?=$mainBanner["id"]?></td>
                                            <td id="mainBanner_image" class="py-2"><img src="<?=$image["file_folder"]?>" width="125px"></td>
                                            <td class="py-2"><?=admin_lng($mainBanner["title"])?></td>
                                            <td class="py-2"><?=admin_lng($mainBanner["sub_title"])?></td>
                                            <td class="py-2"><?=$mainBanner["youtube_link"]?></td>
                                            <td class="py-2"><?=$mainBanner["created_date"]?></td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/admin/editMainBanner/?id=<?=$mainBanner["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="admin/editMainBanner/?id=<?=$mainBanner["id"]?>&type=deletemainbanner">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        // count
                            $count = (int)$db->assoc("SELECT COUNT(*) FROM main_banners")["COUNT(*)"];
