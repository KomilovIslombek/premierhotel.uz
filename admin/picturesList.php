...
$pictures = $db->in_array("SELECT * FROM pictures ORDER BY id ASC LIMIT $page_start, $page_count");
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div style="min-height: 250px;" class="table-responsive">
                            <table class="table table-responsive-md mb-0 table-bordered" id="table">
                                <thead>
                                    <tr>
                                        <th>#id</th>
                                        <th id="table_image">Karta rasmi</th>
                                ...
                                <tbody id="customers">
                                    <? foreach ($pictures as $picture){ ?>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            <td class="py-2"><?=$picture["id"]?></td>
                                            <td class="py-2"><img src="<?=$image["file_folder"]?>" width="125px"></td>
                                            <td class="py-2"><?=$picture["created_date"]?></td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/admin/editPicture/?id=<?=$picture["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="admin/editPicture/?id=<?=$picture["id"]?>&type=deletepicture">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        // count
                            $count = (int)$db->assoc("SELECT COUNT(*) FROM pictures")["COUNT(*)"];
