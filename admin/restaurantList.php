...
$restaurant = $db->in_array("SELECT * FROM restaurant ORDER BY id ASC LIMIT $page_start, $page_count");

include "head.php";

$breadcump_title_1 = "Restoran";
$breadcump_title_2 = "Rasmlar ro'yxati";
?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div style="min-height: 250px;" class="table-responsive">
                            <table class="table table-responsive-md mb-0 table-bordered" id="table">
                                <thead>
                                    <tr>
                                        <th>#id</th>
                                        <th id="table_image">Rasm</th>
                                        <th>Qo'shilgan sana</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody id="customers">
                                    <? foreach ($restaurant as $restaurantImage){ ?>
                                        <?
                                            $image = image($restaurantImage["image_id"]);
                                        ?>
                                        
                                        <tr class="btn-reveal-trigger">
                                            <td class="py-2"><?=$restaurantImage["id"]?></td>
                                            <td class="py-2"><img src="<?=$image["file_folder"]?>" width="125px"></td>
                                            <td class="py-2"><?=$restaurantImage["created_date"]?></td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"  href="/admin/editRestaurant/?id=<?=$restaurantImage["id"]?>">Tahrirlash</a>
                                                            <a class="dropdown-item text-danger" href="admin/editRestaurant/?id=<?=$restaurantImage["id"]?>&type=deleterestaurant">O'chirish</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        // count
                            $count = (int)$db->assoc("SELECT COUNT(*) FROM restaurant")["COUNT(*)"];
