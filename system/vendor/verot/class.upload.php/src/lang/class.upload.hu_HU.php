 ...
 */
    ...
    $translation['uploaded_unknown']            = 'Hiba a fájl feltöltésekor (<?=$words->name?>eretlen hibakód).';
    ...
    $translation['watermark_invalid']           = '<?=$words->name?>eretlen kép formátum, nem olvasható a vízjel.';
